...
-- This script creates the stored procedure sp_RestoreGene, which queries msdb database backup history and database file details in master
-- to build and return RESTORE DATABASE commands as its result set.
